...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference() //TODO: sacar el filename de CameraActivity

        //Event
        btn_upload.setOnClickListener {
            //Write code to pickup image
            val intent = Intent()
            startActivityForResult(/*Iniciar CameraActivity*/, PICK_IMAGE_CODE)
        }
    }
}
